...
export const createEditProfile = async (login) => {
    ...
    const editAvatarImage = createElement('img', {
        className: 'edit_avatar-image',
        src: `${API_URL}/${user.avatar}`,
        alt: `Avatar ${user.login}`
    });

    const editAvatarLoad = createElement('div', {
        className: 'edit_avatar-load',
    });

    const editAvatarLabel = createElement('label', {
        className: 'edit_label-avatar',
        htmlFor: 'avatar-load',
        innerHTML: `
        <svg class="edit_icon-avatar" width="38" height="38" viewBox="0 0 38 38" fill="none"
    ...
    const btnDeleteAvatar = createElement('button', {
        className: 'edit_avatar-delete',
        type: 'button',
        innerHTML: `
        <svg class="edit_icon-avatar" width="38" height="38" viewBox="0 0 38 38" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.48842 29.6389C9.48842 31.35 10.9027 32.75 12.6313 32.75H25.2027C26.9313 32.75 28.3456 31.35 28.3456 29.6389V10.9722H9.48842V29.6389ZM12.6313 14.0833H25.2027V29.6389H12.6313V14.0833ZM24.417 6.30556L22.8456 4.75H14.9884L13.417 6.30556H7.91699V9.41667H29.917V6.30556H24.417Z"
                                      fill="white"/>
                            </svg>
                            Удалить
        `
    ...
    btnDeleteAvatar.addEventListener('click', () => {
        ...
        editAvatarImage.src = 'image/user 1.png'
    });
    ...
    const editNameLabel = createElement('label', {
        ...
        innerHTML: '<span class="edit_label-text">Имя:</span>'
    });
    ...
    const editSurNameLabel = createElement('label', {
        className: 'edit_label',
        innerHTML: '<span class="edit_label-text">Фамилия:</span>'
    });
